...
function tab() {
    ...
    setTimeout(function(){
        ...
        tr.appendChild(th);
            ...
            tr.appendChild(th);
            th = document.createElement("th");
            th.innerText = "Company";
            tr.appendChild(th);
            th = document.createElement("th");
            th.innerText = "Created At";
            tr.appendChild(th);
            th = document.createElement("th");
            ...
            for (let i = 0; i < data.customers.length; i++) {
                ...
                td.innerText = data.customers[i].id;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].email;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].first;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].last;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].company;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].created_at;
                tr.appendChild(td);
                td = document.createElement("td");
                td.innerText = data.customers[i].country;
                tr.appendChild(td);
